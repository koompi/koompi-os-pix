...
pub async fn gql_apps_by_names(
    names: Vec<String>,
) -> Result<Option<types::AppByNames>, anyhow::Error> {
    let req = AppsByNames::build_query(apps_by_names::Variables {
        names: names.clone(),
    });
